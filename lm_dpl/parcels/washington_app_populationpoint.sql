...
DROP TABLE IF EXISTS washington_app_populationpoint;
CREATE TABLE washington_app_populationpoint (
...
INSERT INTO washington_app_populationpoint (
    classification,
    state,
    population,
    place_fips,
